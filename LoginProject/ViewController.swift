...
final class ViewController: UIViewController {
    ...
    lazy var passwordnfoLabelCenterYConstraint = passwordInfoLabel.centerYAnchor.constraint(equalTo: passwordTextFieldView.centerYAnchor)
    ...
    func setUpUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            passwordnfoLabelCenterYConstraint,
...
extension ViewController: UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if textField == emailTextField { //유저가선택한 필드가 이메일텍스트 필드라면,
        ...
        if textField == passwordTextField { //유저가선택한 필드가 패스워드텍스트 필드라면,
            passwordTextFieldView.backgroundColor = .gray
            passwordInfoLabel.font = UIFont.systemFont(ofSize: 11)
            // 오토레이아웃 업데이트
            passwordnfoLabelCenterYConstraint.constant = -13
        }
    ...
    @objc func textFieldEditingChanged(textField: UITextField) {
        ...
        loginButton.isEnabled = true  // 버튼활성화
    }
}
